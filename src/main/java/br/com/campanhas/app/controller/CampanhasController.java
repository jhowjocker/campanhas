...
public class CampanhasController {
	...
	private static final HttpStatus Error = null;
	@Autowired
	...
	public ResponseEntity inserir(@RequestBody CampanhasRequest request) {
		...
		public ResponseEntity listar() {
			try {
					CampanhasList campanhas = service.listar();
		...
		@PutMapping(path = "/{id}")
		public ResponseEntity atualizar(@RequestBody CampanhaSpec campanhaSpec, @PathVariable Long id) {
